...
/**
 * <p>Java-Klasse für IRT01Result complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="IRT01Result">
 *   &lt;complexContent>
...
@XmlType(name = "IRT01Result", propOrder = {
    "erg",
    "ergt",
    "fnr",
    "id",
...
public class IRT01Result {

    @XmlElementRef(name = "_ERG", namespace = "http://irt01e.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> erg;
    @XmlElementRef(name = "_ERGT", namespace = "http://irt01e.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> ergt;
    @XmlElementRef(name = "_FNR", namespace = "http://irt01e.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> fnr;
    @XmlElementRef(name = "_ID", namespace = "http://irt01e.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> id;
    @XmlElementRef(name = "_RGNR", namespace = "http://irt01e.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> rgnr;
    @XmlElementRef(name = "_SBNR", namespace = "http://irt01e.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
