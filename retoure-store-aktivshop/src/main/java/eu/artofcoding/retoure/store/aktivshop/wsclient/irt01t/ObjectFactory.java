...
public class ObjectFactory {
    ...
    private final static QName _Irt01ResponseReturn_QNAME = new QName("http://irt01t.wsbeans.iseries/xsd", "return");
    ...
    public JAXBElement<IRT01Result> createIrt01ResponseReturn(IRT01Result value) {
        return new JAXBElement<IRT01Result>(_Irt01ResponseReturn_QNAME, IRT01Result.class, Irt01Response.class, value);
    }
    ...
    public JAXBElement<String> createIrt01XMLResponseReturn(String value) {
        return new JAXBElement<String>(_Irt01ResponseReturn_QNAME, String.class, Irt01XMLResponse.class, value);
    }
