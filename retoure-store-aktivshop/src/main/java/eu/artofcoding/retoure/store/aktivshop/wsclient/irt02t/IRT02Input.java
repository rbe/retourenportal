...
/**
 * <p>Java-Klasse für IRT02Input complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="IRT02Input">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="_AANRE" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 ...
 *         &lt;element name="_FMNR" type="{http://www.w3.org/2001/XMLSchema}decimal" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "IRT02Input", propOrder = {
    "aanre",
    "alkz",
    "anam2",
    "anam3",
...
public class IRT02Input {

    @XmlElementRef(name = "_AANRE", namespace = "http://irt02t.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> aanre;
    @XmlElementRef(name = "_ALKZ", namespace = "http://irt02t.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> alkz;
    @XmlElementRef(name = "_ANAM2", namespace = "http://irt02t.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> anam2;
    @XmlElementRef(name = "_ANAM3", namespace = "http://irt02t.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> anam3;
    @XmlElementRef(name = "_ANAM4", namespace = "http://irt02t.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> anam4;
    @XmlElementRef(name = "_ANAME", namespace = "http://irt02t.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> aname;
    @XmlElementRef(name = "_AORT", namespace = "http://irt02t.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> aort;
    @XmlElementRef(name = "_APLZ", namespace = "http://irt02t.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> aplz;
    @XmlElementRef(name = "_ASTR", namespace = "http://irt02t.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    ...
    @XmlElement(name = "_FMNR", nillable = true)
    protected List<BigDecimal> fmnr;
    @XmlElementRef(name = "_FNR", namespace = "http://irt02t.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> fnr;
    @XmlElementRef(name = "_KZOP", namespace = "http://irt02t.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> kzop;
    @XmlElementRef(name = "_KZRTER", namespace = "http://irt02t.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> kzrter;
    @XmlElementRef(name = "_RGNR", namespace = "http://irt02t.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> rgnr;
    @XmlElementRef(name = "_SBNR", namespace = "http://irt02t.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> sbnr;
    @XmlElementRef(name = "_VATX", namespace = "http://irt02t.wsbeans.iseries/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> vatx;

    /**
     * Ruft den Wert der aanre-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getAANRE() {
        return aanre;
    }

    /**
     * Legt den Wert der aanre-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setAANRE(JAXBElement<String> value) {
        this.aanre = value;
    }
    ...
    /**
     * Gets the value of the fmnr property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the fmnr property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<BigDecimal> getFMNR() {
        if (fmnr == null) {
            fmnr = new ArrayList<BigDecimal>();
        }
        return this.fmnr;
    }
