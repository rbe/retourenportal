 ...
 * 
 */
@WebServiceClient(name = "RpPartnerService", targetNamespace = "https://amsel.dpwn.net/abholportal/gw/lp/schema/1.0/var3ws", wsdlLocation = "file:/Users/rbe/project/artofcoding.eu/retoure-server/retoure-dhl-client/src/main/resources/wsdl/var3ws.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/Users/rbe/project/artofcoding.eu/retoure-server/retoure-dhl-client/src/main/resources/wsdl/var3ws.wsdl");
